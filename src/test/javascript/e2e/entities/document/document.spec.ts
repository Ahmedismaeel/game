...
describe('Document e2e test', () => {
  ...
  it('should load Documents', async () => {
    ...
    expect(await documentComponentsPage.getTitle()).to.eq('justgameApp.document.home.title');
  });
  ...
  it('should load create Document page', async () => {
    ...
    expect(await documentUpdatePage.getPageTitle()).to.eq('justgameApp.document.home.createOrEditLabel');
  ...
  /*  it('should delete last Document', async () => {
        ...
        expect(await documentDeleteDialog.getDialogTitle())
            .to.eq('justgameApp.document.delete.question');
